...
void update_TreeWaterNutritionAge(tree* x) // function to update water, nutrition and age of tree every 1 second, same as above
{   
    int live = 0;
...
void additional_opt(char x, user &xx) // function to show additional options based on the type of plant (flower or tree), this function is called only if the user chooses to show the flower or tree list
{
    vector<vector<string>> options;
    vector<string> option;
